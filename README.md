...
- 라운드 종료 후 30초 검증 라운드에서 모든 플레이어 위치 공개
...
3. **검증 라운드** — 마지막 30초 동안 모든 카멜레온의 위치를 공개합니다. 숨은 장소를 감상하고 결과를 확인합니다.
4. **노말** — 잡히면 그 라운드 아웃. 한 명이라도 끝까지 남으면 카멜레온 승.
5. **감염** — 잡히면 술래가 됩니다. 마지막까지 숨은 사람이 이깁니다.
